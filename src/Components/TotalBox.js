			...
			<Grid container justifyContent="center">
				<Grid item xs={12} md={10}>
					<Grid container spacing={4} alignItems="center" sx={{ py: 5 }}>
						...
						<Grid item md={3} xs={6}>
							<DateSearch onSelectDate={() => {}} /> {/* Placeholder for DateSearch component */}
						</Grid>
						<Grid item md={3} xs={6}>
							<DateSearch onSelectDate={() => {}} /> {/* Placeholder for DateSearch component */}
						</Grid>
					...
					<Grid container spacing={4}>
						<Grid item xs={12} md={3} className="type">
							...
							<FormControl fullWidth variant="outlined" className="mb-4">
								...
								<Select labelId="type-label" id="type" label="Type" defaultValue="signup">
						...
						<Grid item xs={12} md={6}>
							<FormControl fullWidth variant="outlined" sx={{ my: 1 }}>
								...
								>
									...
									{/* Placeholder for country filter options */}
								</Select>
							</FormControl>
						</Grid>

						<Col md={3} className="text-light ps-1 pe-5 pb-3">
							<Row>
								<Col xs={6}>
						...
						<Grid item xs={12} md={6}>
							<FormControl fullWidth variant="outlined" sx={{ my: 1 }}>
								...
								>
									...
									{/* Placeholder for type filter options */}
								</Select>
							</FormControl>
						</Grid>
